...
export default function(props) {
  ...
  return <div className="plg-do-tab-content">
    <Search className="plg-do-search" size="lg" placeholder="Filter for Variables for Name, Origin, or Scope" labelText="Filter" closeButtonLabelText="Clear filter input" id="search-1" onChange={ handleSearch } />
