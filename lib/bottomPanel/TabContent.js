...
export default function(props) {
  ...
  return <>
    <Search size="lg" placeholder="Filter for Variables for Name, Origin, or Scope" labelText="Filter" closeButtonLabelText="Clear filter input" id="search-1" onChange={ handleSearch } />
